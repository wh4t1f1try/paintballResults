...
public class TestRecordsGenerator
{
    ...
    public string[] CreateRecordWithInvalidTestItem(string testItem)
    {
    ...
    public static IEnumerable<string[]> CreateInvalidTestRecords()
    {
    ...
    public static IEnumerable<string[]> CreateValidTestRecords()
    {
    ...
    public static IEnumerable<string[]> CreateValidDataStrings()
    {
    ...
    public static IEnumerable<string[]> CreateInvalidDataStrings()
    {
        yield return new[] { GenerateRandomString(5, 23) };
        yield return new[] { GenerateRandomString(5, 23) };
        yield return new[] { GenerateRandomString(5, 23) };
        yield return new[] { GenerateRandomString(5, 23) };
    }
